...
import 'package:finalauth_news/views/homepage.dart';
             ...
             padding: EdgeInsets.fromLTRB(20,120,20,0),
              child: Column(
               ...
               reusableTextField('Enter Name',Icons.person_outline,false,_userNameTextController),
                const SizedBox(
               height: 20,),
               reusableTextField('Enter User-email',Icons.person_outline,false,_emailTextController),
               const SizedBox(
              height: 20,
               ),
               reusableTextField('Enter User-Password',Icons.lock_outline,true,_passwordTextController),
                const SizedBox(
                 height: 20,
                ),
